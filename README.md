...
- **viegphunt** — pixel-oriented Catppuccin Mocha Hyprland LARP of [ViegPhunt/Dotfiles](https://github.com/ViegPhunt/Dotfiles) (visual only; JetBrainsMono Nerd Font for Waybar glyphs; wallpaper picker via **Walls** / Super+W)
...
| Keys | Action |
|------|--------|
| **Super+1…4** / click WS | Switch workspaces 1–4 (each keeps open apps) |
| **Super+Space** / **Super+D** | Rofi-like launcher (filter + Enter / Esc) |
| **Super+H** / **?** | Keybind overlay |
